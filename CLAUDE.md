# CLAUDE.md — EazyBank (section_17)

Plataforma de 6 microservicios Spring Boot. Este archivo da contexto estable al
agente en cada sesión. Mantener corto: si algo es un procedimiento largo, va a un
skill; si es una regla que debe cumplirse siempre, va a un hook o al CI.
